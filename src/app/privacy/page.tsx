    ...
    <div className="flex flex-col min-h-screen bg-[#030014]">
      ...
      <main className="flex-grow mx-auto max-w-4xl w-full px-6 py-16 text-slate-300 relative z-10 leading-relaxed">
        ...
        <section className="space-y-6 text-sm">
          <p>
            At <strong>InterviewAce.AI</strong> (accessible from <a href="https://interviewaceai.online" className="text-brand-cyan hover:underline">https://interviewaceai.online</a>), one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by InterviewAce.AI and how we use it.
          </p>
          ...
          <div>
            ...
            <p>
              Third-party ad servers or ad networks use technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on InterviewAce.AI, which are sent directly to users' browsers. They automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of their advertising campaigns and/or to personalize the advertising content that you see on websites that you visit.
            </p>
            <p className="mt-2 text-slate-400 text-xs">
              Note that InterviewAce.AI has no access to or control over these cookies that are used by third-party advertisers.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us at: <span className="text-brand-cyan">support@interviewaceai.online</span>.
            </p>
          </div>
        </section>
      </main>
