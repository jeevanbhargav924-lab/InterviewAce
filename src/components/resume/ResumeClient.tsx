...
JavaScript, React, CSS, HTML, databases, Git.`);
  ...
  return (
    <>
      ...
      {error && (
        <div className="mb-6 rounded-lg bg-red-500/10 border border-red-500/20 p-4 text-xs text-red-400 text-left">
          {error}
        </div>
      )}
        ...
        <div className="lg:col-span-2 space-y-6 text-left">
          <div className="bg-glass rounded-xl p-6 border border-slate-800">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="text-[10px] text-brand-cyan hover:text-brand-purple font-semibold hover:underline cursor-pointer"
              >
            ...
            <form onSubmit={handleFormSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between flex-wrap gap-4 pt-2">
                ...
                <button
                  ...
                  className="rounded-lg bg-gradient-to-r from-brand-purple to-brand-cyan px-6 py-2.5 text-xs font-semibold text-white shadow-xl hover:brightness-110 disabled:opacity-40 transition-all flex items-center space-x-1 cursor-pointer"
                >
          ...
          {report && (
            <div className="space-y-6 animate-fadeIn">
              ...
              {/* Bullet Optimization comparative */}
